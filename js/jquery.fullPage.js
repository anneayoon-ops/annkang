        ...
        */
        function addMouseWheelHandler(){
            ...
            if(support == 'DOMMouseScroll'){
                document[ _addEventListener ](prefix + 'MozMousePixelScroll', MouseWheelHandler, {passive: false, capture: false});
            }

            //handle MozMousePixelScroll in older Firefox
            else{
                document[ _addEventListener ](prefix + support, MouseWheelHandler, {passive: false, capture: false});
            }
        }
